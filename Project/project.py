...
def TaskExe():
    ...
    def screenshot():
        ...
        nme = takecommand()
        pth = nme + '.jpeg'
        pth1 = 'C:\\Users\\akhil\\Pictures\\Screenshots\\'+pth
        ss = pyautogui.screenshot()
        ss.save(pth1)
        os.startfile('C:\\Users\\akhil\\Pictures\\Screenshots')
        speak('Here is your screenshot present sir!')
    def TakeHindi():
        command  = sr.Recognizer() # this will recognize our voice which we gave and save to command
        with sr.Microphone() as source:  # will take our audio through microphone as audio source
            print ("Listening......")
        ...
        if 'hello' in query:
            ...
            while True:
                ...
                if now == time:
                    ...
                    while True:
                        if now == time:
                            playsound('iphone_alarmringtone.mp3')
